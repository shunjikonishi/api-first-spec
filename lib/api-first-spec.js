...
function API(config) {
  ...
  function buildParameters(name, params, rules, strict) {
    var ret = new Param(name, params, strict);
    if (rules) {
      testRulesReference(ret, rules);
    }
    ret.build();
    return ret;
  }
  ...
  function testRequest() {
    ...
    if (req.params) {
      req.params = buildParameters("request", req.params, req.rules, !!req.strict);
    }
  }
  function testResponse() {
    ...
    res.data = buildParameters("reponse", res.data, res.rules, !!res.strict);
  }
  ...
  function validateResponse(data, res, req) {
    ...
    assert.equal(config.respone.contentType, resContentType,
